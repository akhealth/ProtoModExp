...
public class ApplicationController {
	...
	@PutMapping("/{id}")
	public ResponseEntity<Object> updateApplication(@PathVariable(value = "id") String appNum, @Valid @RequestBody Application appDetails) {
	...
	public ResponseEntity<Object> addPersonToApplication(@PathVariable(value = "appId") String appId,@PathVariable(value = "personId") long personId) {
	...
	public ResponseEntity<Object> removePersonFromApplication(@PathVariable(value = "appId") String appId, @PathVariable(value = "personId") long personId) {
		Optional<Application> application = applicationRepository.findById(appId);
		if (application.isEmpty()) {
			return new ResponseEntity<>("The application was not found.", HttpStatus.NOT_FOUND);
		}
